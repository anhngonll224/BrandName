...
export default function HistoryModal(props) {
  const { isOpen, onClose, title, columnsHistory, rowKey, historyApi, detailInfo } = props
  ...
  return (
    <CustomModal
      ...
      maskClosable={false}
    >
      <HistoryTable loading={loading} tableData={dataTable} columnsData={columnsCustom} rowKey={rowKey} />
