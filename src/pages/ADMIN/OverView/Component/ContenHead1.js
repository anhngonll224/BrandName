      ...
      <Row className="maine">
        <Col className="maineBox paddingBottom">
          <Row>
            ...
            <Col span={10}>
              ...
              // onClick={() =>
              //   navigate(`${ROUTER.QUAN_LY_HO_SO}/cho-xu-ly`, {
              //     state: { Procedure: 2 },
              //   })
              // }
              >
            ...
            <Col span={6}>
              {/* <a
                ...
                // href="#"
                onClick={() =>
                  navigate(`${ROUTER.QUAN_LY_HO_SO}/cho-xu-ly`, { state:  { Procedure: 2 } })
                }
              >
                Xem
              </a> */}
        ...
        <Col className="maineBox">
          <Row>
            ...
            <Col span={16}>
              <div className="textHeadConten pt-3">
            ...
            {/* <Col span={6}>
              <a
                ...
                // href="#"
                onClick={() =>
                  navigate(`${ROUTER.QUAN_LY_HO_SO}/cho-xu-ly`, { state:  { Procedure: 5 } })
                }
              >
                Xem
              </a>
